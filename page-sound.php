<?php
/*
 Template Name: Flavorlab Sound Homepage Template
*/

 // Default category for the work menu for this section
 $defaultCategoryId = 39;

?>

<?php get_header(); ?>

      <?php include_once('includes/SIDEBAR-Sound.php'); ?>
      ...
      <div id="content">
        ...
        <div id="inner-content">
            ...
            <main id="main" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
             ...
             <!-- Movies -->
              <p id="audiopost" style="margin-bottom: 0px;">&nbsp;</p>
              <?php $page_id = 4717; $page_data = get_page( $page_id ); $image = wp_get_attachment_url( get_post_thumbnail_id($page_id)); $page_title = get_the_title($page_id); ?>
              <div class="section" id="audio-movies" style="background: url(<?php echo $image ?>) top center no-repeat; background-size:cover;">
                <div class="sectionInner">
                 <h1 class="sectionTitle" style="font-size: 60px; line-height: 60px; font-weight: bold; text-transform:uppercase;margin: 0 0 30px 0;"><?php echo $page_title ?></h1>
                  <?php echo apply_filters('the_content', $page_data->post_content); ?>
                </div>
              </div><!--- // Movies -->	
              
		<div id="workContainer" style="position: relative;">
              <!-- Category Switch -->
              ...
              <!-- About -->
              <?php $page_id = 375; $page_data = get_page( $page_id ); $image = wp_get_attachment_url( get_post_thumbnail_id($page_id)); ?>
              ...
              <!-- Team -->
              <?php $page_id = 258; $page_data = get_page( $page_id ); $image = wp_get_attachment_url( get_post_thumbnail_id($page_id)); ?>
              ...
              <div class="section" id="team" style="background: url(<?php echo $image ?>) center center no-repeat; background-size:cover;">
                ...
                <div id="teamMembers" class="flexslider">
                  <ul class="slides">
                  <?php query_posts('cat=19'); if (have_posts()) : while (have_posts()) : the_post(); $image = wp_get_attachment_url( get_post_thumbnail_id($the_ID)); ?>
                    <li>
              ...
              <!-- Services -->
              <?php $page_id = 399; $page_data = get_page( $page_id ); $image = wp_get_attachment_url( get_post_thumbnail_id($page_id)); ?>
      ...
      <footer class="footer" role="contentinfo" itemscope itemtype="http://schema.org/WPFooter">
        <div id="inner-footer">
          ...
          <p>212.673.2773<br/><a class="mail-us" href="mailto:booking@flavorlab.com"><span data-title="licensing@flavorlab.com">Email Booking</span></a></p>
        </div>
      </footer>
